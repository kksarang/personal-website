...
export const ServiceIndex = () => {
    ...
    return (
        <section id="services" className="enitexa-editorial relative bg-[#0B0F19] py-16 sm:py-24 lg:py-28">
            <div className="mx-auto max-w-[90rem] px-4 sm:px-10 lg:px-16">
                <div className="flex flex-col gap-6 border-b border-white/[0.08] pb-10 sm:gap-8 sm:pb-12 lg:flex-row lg:items-end lg:justify-between">
                    <div className="min-w-0 max-w-3xl">
                        ...
                        <h2 className="pf-display text-[clamp(1.75rem,6.5vw,3.75rem)] font-extrabold leading-[0.98] tracking-[-0.03em] text-white">
                            Everything to build,
                            <br />
                ...
                <div className="mt-2">
                    {services.map((service) => (
                        <button
                            ...
                            data-cursor="Open"
                            className="group grid w-full grid-cols-[auto_minmax(0,1fr)_auto] items-start gap-3 border-b border-white/[0.08] py-6 text-left sm:items-baseline sm:gap-8 sm:py-9"
                        >
                            <span className="pf-mono pt-1 text-[10px] text-indigo-300/80 sm:pt-0 sm:text-xs">{service.index}</span>
                            <span className="min-w-0">
                                <span className="pf-display block text-[clamp(1.2rem,4.5vw,2.1rem)] font-bold text-white transition-transform duration-500 group-hover:translate-x-1.5">
                                    {service.title}
                                </span>
                            ...
                            <ArrowUpRight className="mt-1 h-5 w-5 shrink-0 text-slate-600 transition-all duration-500 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-white sm:mt-0" />
                        </button>
                    ))}
                </div>
...
export const ProcessStrip = () => {
    ...
    return (
        <section id="process" className="enitexa-editorial relative border-t border-white/[0.06] bg-[#0B0F19] py-16 sm:py-24 lg:py-28">
            <div className="mx-auto max-w-[90rem] px-4 sm:px-10 lg:px-16">
                <SectionLabel index="03" label="Process" />
                <h2 className="pf-display max-w-3xl text-[clamp(1.65rem,5.5vw,3.1rem)] font-extrabold leading-[1.02] tracking-[-0.03em] text-white">
                ...
                <div className="mt-10 grid gap-0 border-t border-white/[0.08] sm:mt-14 sm:grid-cols-2 lg:grid-cols-5">
                    {steps.map((step, idx) => (
                        <div
                            key={step.title}
                            className="group border-b border-white/[0.08] py-6 sm:px-5 sm:py-8 lg:border-b-0 lg:border-l lg:border-white/[0.08] lg:first:border-l-0 lg:first:pl-0"
                        >
                            <p className="pf-mono text-[10px] text-indigo-300/70">0{idx + 1}</p>
                            <p className="pf-display mt-3 text-lg font-bold text-white sm:text-2xl">{step.title}</p>
...
export const ProofBand = () => {
    ...
    return (
        <section className="enitexa-editorial relative border-t border-white/[0.06] bg-[#0B0F19] py-16 sm:py-24 lg:py-28">
            <div className="mx-auto max-w-[90rem] px-4 sm:px-10 lg:px-16">
                <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
                    <div className="min-w-0">
                        <SectionLabel index="04" label="Proof" />
                        <h2 className="pf-display text-[clamp(1.65rem,5.5vw,3.1rem)] font-extrabold leading-[1.02] tracking-[-0.03em] text-white">
                        ...
                        <p className="pf-mono mt-8 text-[9px] uppercase leading-relaxed tracking-[0.16em] text-slate-600 sm:text-[10px] sm:tracking-[0.22em]">
                    ...
                    <div className="grid grid-cols-2 gap-px overflow-hidden border border-white/[0.08] bg-white/[0.08]">
                        {metrics.map((m) => (
                            <div key={m.label} className="min-w-0 bg-[#0B0F19] px-4 py-6 sm:px-8 sm:py-10">
                                <p className="pf-display text-[clamp(1.75rem,6vw,2.75rem)] font-extrabold leading-none text-white">
                                    {m.value}
                                </p>
                                <p className="pf-mono mt-3 text-[8px] uppercase tracking-[0.16em] text-slate-500 sm:text-[9px] sm:tracking-[0.22em]">
                                    {m.label}
                                </p>
                            </div>
                        ))}
    ...
    return (
        <section className="enitexa-editorial relative border-t border-white/[0.06] bg-[#0B0F19] py-16 sm:py-24 lg:py-28">
            <div className="mx-auto max-w-[90rem] px-4 sm:px-10 lg:px-16">
                ...
                <div className="mt-10 grid gap-0 border-t border-white/[0.08] sm:mt-14 lg:grid-cols-2">
                    <article className="border-b border-white/[0.08] py-8 lg:border-b-0 lg:border-r lg:pr-12 lg:pt-12">
                        <p className="pf-mono text-[10px] uppercase tracking-[0.28em] text-indigo-300">Enitexa.Ai ERP</p>
                        <h3 className="pf-display mt-4 text-xl font-bold text-white sm:text-3xl">
                        ...
                        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                            <button
                                ...
                                data-cursor="Demo"
                                className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-white bg-white px-6 py-3 text-sm font-semibold text-black transition hover:bg-transparent hover:text-white sm:w-auto"
                            >
                            ...
                            <button
                                ...
                                className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-white/20 px-6 py-3 text-sm font-semibold text-white transition hover:border-white sm:w-auto"
                            >
                                Features
                            </button>
                        </div>
                    ...
                    <article className="py-8 lg:pl-12 lg:pt-12">
                        ...
                        <div className="mt-8">
                            <button
                                ...
                                data-cursor="Open"
                                className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-white/20 px-6 py-3 text-sm font-semibold text-white transition hover:border-white hover:bg-white hover:text-black sm:w-auto"
                            >
    ...
    return (
        <section className="enitexa-editorial relative border-t border-white/[0.06] bg-[#0B0F19] py-16 sm:py-24 lg:py-28">
            <div className="mx-auto max-w-[90rem] px-4 sm:px-10 lg:px-16">
                ...
                <h2 className="pf-display max-w-2xl text-[clamp(1.65rem,5.5vw,3.1rem)] font-extrabold leading-[1.02] tracking-[-0.03em] text-white">
                    Teams that shipped with us.
                </h2>

                <div className="mt-10 space-y-0 border-t border-white/[0.08] sm:mt-14">
                    {quotes.map((item) => (
                        <blockquote
                            key={item.by}
                            className="border-b border-white/[0.08] py-7 sm:py-10"
                        >
                            <p className="pf-display max-w-4xl text-[clamp(1.05rem,4.2vw,1.65rem)] font-medium leading-snug text-white/90">
                                “{item.quote}”
                            </p>
                            <footer className="pf-mono mt-4 text-[9px] uppercase tracking-[0.16em] text-slate-500 sm:text-[10px] sm:tracking-[0.22em]">
                                {item.by}
                            </footer>
                        </blockquote>
                    ))}
